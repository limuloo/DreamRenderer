...
class UNetModel(nn.Module):
    ...
    def restore_first_conv_from_SD(self):
        if self.first_conv_restorable:
            ...
            if not self.sd_v1_5:
                SD_weights = th.load("L2I_methods/InstanceDiffusion/pretrained/SD_input_conv_weight_bias.pth")
            else:
                SD_weights = th.load("L2I_methods/InstanceDiffusion/pretrained/SD_v1_5_input_conv_weight_bias.pth")
